...
\begin{proposition}[Proprietà delle operazioni sui numeri aleatori]{\ \\} % trick per aggiungere un a-capo in più
  Distributiva:
  \begin{align*}
...
\begin{definition}[Proprietà degli eventi]
  ...
  \marginnote{Il simbolo $\vdash$ indica che la proposizione seguente è sicuramente vera}
