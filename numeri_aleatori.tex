...
\begin{definition}[Implicazione]\label{def:implicazione}
  ...
  Denotiamo dunque che $A$ implica $B$ con \( A \subseteq B \), che $A$ è identico a $B$ con \( A \equiv B \) e che $A$ implica strettamente $B$ con \( A \subset B \).
\end{definition}
...
\begin{definition}[Proprietà degli eventi]
  ...
  Partizione
  \footnote{ovvero incompatibili ed esaustivi. Anche detti eventi mutuamente esclusivi.}:
...
Sono possibili tutti i costituenti solo se gli $E_i$ sono logicamente indipendenti.
